...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="admin-card-modern card shadow-sm">
                <div class="card-body text-center">
                    <h5 class="mb-3 fw-bold">Redirection vers la page de paiement sécurisée</h5>
                    ...
                    <form id="cmiForm" method="post" action="https://cmi-gateway-url-sandbox">
                        ...
                        <button type="submit" class="btn btn-modern mt-3">
