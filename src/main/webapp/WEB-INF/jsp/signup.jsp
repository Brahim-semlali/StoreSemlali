...
<html>
<head>
    <title>Inscription - Fdarna Cuisine</title>
        ...
        <div class="auth-hero">
            <div class="auth-hero-content">
                ...
                <div class="auth-badge mb-3">
                    ...
                    <span>Recettes familiales & plats maison</span>
                </div>
                <h2>Créez votre compte gourmand</h2>
                <p>Enregistrez-vous pour commander plus vite, enregistrer vos repas favoris et suivre vos livraisons.</p>
        ...
        <c:if test="${not empty error}">
            ...
            <form method="post" action="/signup" class="mt-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="confirmPassword" placeholder="Confirmez le mot de passe" required>
                </div>
